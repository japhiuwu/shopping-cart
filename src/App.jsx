...
export default function App() {
  ...
  return (
    <div className="font-sans">
      ...
      {/* Sección "Sobre Nosotros" encima de la imagen parallax */}
      <div className="relative h-[500px] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-40 text-white px-4 text-center">
          ...
          <p className="max-w-2xl">
            ...
            necesitas para estar al día con tus artistas preferidos.
          </p>
        </div>
      </div>
      ...
      <section className="py-16 px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-white">Merchandising</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
